...
| [`examples/offline/`](examples/offline/) | Any podcast to transcript, summary and a vertical clip of a quote, on your own machine. Also dictation, a searchable archive and a comparison of two episodes | Locally |
